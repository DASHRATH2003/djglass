  ...
  const imageArray = [
    {
      ...
      altText: "Aluminum Partition Work 1",
    },
    {
      imageID: 2,
      imageURL: profileGlass2,
      altText: "Aluminum Partition Work 2",
    },
    {
      imageID: 3,
      imageURL: profileGlass3,
      altText: "Aluminum Partition Work 3",
    },
  ];
  ...
  const application = [
    {
      ...
      appDesc: "Modern office spaces and workstations",
      appImage: profileGlass1,
    },
    {
      appID: 2,
      appName: "Commercial Spaces",
      appDesc: "Retail stores and showrooms",
      appImage: profileGlass2,
    },
    {
      appID: 3,
      appName: "Educational Institutions",
      appDesc: "Schools, colleges and training centers",
      appImage: profileGlass3,
    },
    {
      appID: 4,
      appName: "Healthcare Facilities",
      appDesc: "Hospitals, clinics and medical centers",
      appImage: profileGlass1,
    },
  ];
    ...
    <main>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="flex flex-col gap-6">
            <p className="text-base sm:text-lg">
              Aluminum partition systems offer a sleek, modern solution for dividing spaces in commercial and residential settings. At DJ Glass Interiors Solutions, we provide premium aluminum partition solutions that combine durability, aesthetics, and functionality to create versatile spaces tailored to your specific requirements.
            </p>
            <div>
      ...
      <div className="mt-12 mb-8">
        <div className="mb-8 ml-6">
          ...
          <p>Take a look at some of our completed aluminum partition projects..</p> 
        </div> 
...
export default AluminumPartitionWork;
