...
const GypsumPartitionWork = () => {
  ...
  const imageArray = [
    {
      ...
      altText: "Gypsum Partition Work 1",
    },
    {
      imageID: 2,
      imageURL: profileGlass2,
      altText: "Gypsum Partition Work 2",
    },
    {
      imageID: 3,
      imageURL: profileGlass3,
      altText: "Gypsum Partition Work 3",
    },
  ];
  ...
  const application = [
    ...
    },
    {
      appID: 3,
      appName: "Residential",
      appDesc: "Residential interiors like bedrooms or living areas",
      appImage: profileGlass3,
    },
    {
      appID: 4,
      appName: "Commercial Spaces",
      appDesc: "Commercial spaces such as malls and showrooms",
      appImage: profileGlass1,
    },
  ];
    ...
    <main>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="flex flex-col gap-6">
            <p className="text-base sm:text-lg">
              Gypsum partition walls are versatile, cost-effective solutions for dividing interior spaces in both residential and commercial buildings. At DJ Glass Interiors Solutions, we specialize in designing and installing high-quality gypsum partitions that combine functionality, aesthetics, and durability to meet your specific requirements.
            </p>
            <div>
      ...
      <div className="mt-12 mb-8">
        <div className="mb-8 ml-6">
          ...
          <p>Take a look at some of our completed gypsum partition projects..</p> 
        </div> 
...
export default GypsumPartitionWork;
