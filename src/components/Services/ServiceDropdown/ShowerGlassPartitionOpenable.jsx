  ...
  const imageArray = [
    {
      ...
      altText: "Shower Glass Partition Openable 1",
    },
    {
      imageID: 2,
      imageURL: profileGlass2,
      altText: "Shower Glass Partition Openable 2",
    },
    {
      imageID: 3,
      imageURL: profileGlass3,
      altText: "Shower Glass Partition Openable 3",
    },
  ];
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="flex flex-col gap-6">
            <p className="text-base sm:text-lg">
              DJ Glass Interiors Solutions offers premium Shower Glass Partition
              Openable solutions that combine functionality with elegant design.
              Our openable shower partitions provide easy access while
              maintaining a sleek, modern aesthetic for your bathroom.
            </p>
            <div>
              ...
              <ul className="mt-4 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>Easy Access and Convenience</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaAnglesRight className="fill-[#080F3B] mt-1 flex-shrink-0" />
        ...
        <div className="mt-12 mb-8">
          <div className="mb-8 ml-6">
            ...
            <p> Explore our beautiful sliding shower glass partition projects in
              detail.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="h-[300px] overflow-hidden rounded-lg">
              <img
                src={profileGlass1}
                alt="Shower Glass Partition Openable 1"
            ...
            <div className="h-[300px] overflow-hidden rounded-lg">
              <img
                src={profileGlass2}
                alt="Shower Glass Partition Openable 2"
                className="object-cover w-full h-full transition-transform duration-300 hover:scale-105"
              />
            </div>
            <div className="h-[300px] overflow-hidden rounded-lg">
              <img
                src={profileGlass3}
                alt="Shower Glass Partition Openable 3"
                className="object-cover w-full h-full transition-transform duration-300 hover:scale-105"
              />
            </div>
          </div>
